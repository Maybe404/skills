...
每组冲突一小节：涉及的规则 id、各自主张什么、为什么选了这一条、被放弃的那条记成了什么 decision、两条在 relations 里记成了什么关系。单一来源的强风格意见没进默认规则的，也写在这里。

按 criteria.md 第 10 条的标准写：每条要写到被放弃那条规则的原作者读了能理解为什么——他那条规则针对什么现象、本仓库为什么选了另一条、如果他那个场景成立该怎么开启（作为可选项开、还是本仓库没留这个口子）。

## 6 被拒绝规则与理由

decision 为 rejected 的每条一行：规则 id、rule_summary、拒绝理由、对应 criteria.md 的哪一条。落在 criteria.md 第 5 条三类内容里的单列，写明是哪一类。

拒绝理由同样按 criteria.md 第 10 条的标准写：写清这条规则针对的现象、本仓库为什么不采纳、他那个场景成立时怎么办。只写"不可判定""证据不足""与本仓库风格不符"不算理由。一行放不下的，另起一小节展开。
